...
class ThreeLayerConvNet(object):
    ...
    This class does not implement an optimizer. It will interact with a separate solver (provided in the CS 231n class 
    material)
    ...
    def __init__(self, input_dim, hidden_dim, output_dim, num_filters, filter_size = (7,), pool_kernel = (2,), pad = 1, filter_stride = 1, pool_stride =2,  wt_init_std = 0.001, reg = 0.0, dtype = np.float32):
        ...
        assert (var_H_pool == 0 and var_W_pool ==0), 'Pool kernel and input dimensions do not work. 
